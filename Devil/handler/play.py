...
import aiofiles
import aiohttp
from eSport.converter import convert
import ffmpeg
import requests
from cache.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from eSport.config import ASSISTANT_NAME, BOT_USERNAME
...
from eSport.inline import stream_markup, audio_markup
        ...
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    ...
                    caption=f"**❰ 𝗘𝘅𝗽𝗼𝗿𝘁 𝗣𝗹𝗮𝘆𝗲𝗿 ❱ 𝗦𝗼𝗻𝗴 ❤️ 𝗣𝗼𝘀𝗶𝘁𝗶𝗼𝗻 💫🤟\n\n**𝗥𝗲𝗾𝘂𝘀𝘁𝗲𝗱 𝗯𝘆:{m.from_user.mention()}",
             ...
             try:
                ...
                await m.reply_photo(
                    ...
                    caption=f"**❰ 𝗘𝘅𝗽𝗼𝗿𝘁 𝗣𝗹𝗮𝘆𝗲𝗿 ❱ 𝗡𝗼𝘄 😄 𝗣𝗹𝗮𝘆𝗶𝗻𝗴 📀 𝗔𝘁 🤟\n\n👤𝗥𝗲𝗾𝘂𝗲𝘀𝘁𝗲𝗱 𝗕𝘆:{requester}**",
                    reply_markup=InlineKeyboardMarkup(buttons),
                )
             except Exception as e:
                await suhu.delete()
            ...
            if search == 0:
                ...
                if abhi == 0:
                    ...
                    if chat_id in QUEUE:
                        ...
                        await m.reply_photo(
                            photo=queueimg,
                            caption=f"**❰ 𝗘𝘅𝗽𝗼𝗿𝘁 𝗣𝗹𝗮𝘆𝗲𝗿 ❱ 𝗦𝗼𝗻𝗴 ❤️ 𝗣𝗼𝘀𝗶𝘁𝗶𝗼𝗻 💫🤟**:{requester}",
